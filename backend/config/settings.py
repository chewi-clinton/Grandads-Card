...
# Database — falls back to local sqlite until a real DATABASE_URL is provided.
DATABASES = {
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Grandad's Cards API",
    "DESCRIPTION": "Backend API for the Grandad's Cards storefront and admin.",
    "VERSION": "1.0.0",
}
